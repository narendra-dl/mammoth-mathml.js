...
function BodyReader(options) {
    ...
    function readRunProperties(element) {
        return readRunStyle(element).map(function(style) {
            ...
            var colorStr = element.firstOrEmpty("w:color").attributes['w:val']
            var color = colorStr ? '#'+colorStr : null

            var bgColorStr = element.firstOrEmpty("w:highlight").attributes['w:val']
            var bgColor = bgColorStr ? bgColorStr : null
